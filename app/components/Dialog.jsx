  ...
  return (
    ...
    >
      <div className="fixed inset-0 bg-neutral-800/80 backdrop-blur flex flex-col items-center justify-center p-4">
        <DialogPrimitive.Panel className="w-[min(720px,_100%)] bg-white p-4 rounded-lg shadow-sm flex flex-col items-stretch justify-start gap-4">
          <div className="flex items-end justify-between flex-wrap-reverse gap-2">
            <div>
              ...
              {description ? (
                <DialogPrimitive.Description className="text-neutral-500">
                  {description}
